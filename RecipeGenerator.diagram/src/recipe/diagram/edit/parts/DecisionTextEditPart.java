 ...
 * @generated
 */
public class DecisionTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DecisionTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeParserProvider.getParser(RecipeElementTypes.Decision_2005, getParserElement(),
					RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.DecisionTextEditPart.VISUAL_ID));
		}
		return parser;
	}

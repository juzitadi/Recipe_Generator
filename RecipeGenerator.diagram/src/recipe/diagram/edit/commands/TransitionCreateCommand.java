...
public class TransitionCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return RecipeBaseItemSemanticEditPolicy.getLinkConstraints().canCreateTransition_4001(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Transition newElement = RecipeFactory.eINSTANCE.createTransition();

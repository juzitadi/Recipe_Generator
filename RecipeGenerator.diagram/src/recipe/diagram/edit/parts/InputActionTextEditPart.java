 ...
 * @generated
 */
public class InputActionTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InputActionTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeParserProvider.getParser(RecipeElementTypes.InputAction_2003, getParserElement(),
					RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.InputActionTextEditPart.VISUAL_ID));
		}
		return parser;
	}

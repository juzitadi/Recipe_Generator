 ...
 * @generated
 */
public class IngredientItemProvider extends VariableItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIngredientPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Ingredient feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIngredientPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ingredient_ingredient_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ingredient_ingredient_feature", "_UI_Ingredient_type"),
				 RecipePackage.Literals.INGREDIENT__INGREDIENT,
				 true,
				 false,
				 false,
	...
	protected void addAmountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ingredient_amount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ingredient_amount_feature", "_UI_Ingredient_type"),
				 RecipePackage.Literals.INGREDIENT__AMOUNT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

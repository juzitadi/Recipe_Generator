...
public class ModelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeParserProvider.getParser(RecipeElementTypes.Model_2004, getParserElement(),
					RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.ModelNameEditPart.VISUAL_ID));
		}
		return parser;
	}

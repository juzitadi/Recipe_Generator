...
import recipe.diagram.edit.policies.ModelCanonicalEditPolicy;
import recipe.diagram.edit.policies.ModelItemSemanticEditPolicy;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command
							.chain(new ICommandProxy(new RecipeCreateShortcutDecorationsCommand(getEditingDomain(),

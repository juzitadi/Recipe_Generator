...
public class IngredientEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IngredientNameTypeEditPart) {
			((IngredientNameTypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureIngredientLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(RecipeVisualIDRegistry.getType(IngredientNameTypeEditPart.VISUAL_ID));
	}

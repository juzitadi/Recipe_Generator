...
/**
 * This is the item provider adapter for a {@link recipe.Device} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceItemProvider extends VariableItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_device_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_device_feature", "_UI_Device_type"),
				 RecipePackage.Literals.DEVICE__DEVICE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Device.class)) {
			case RecipePackage.DEVICE__DEVICE:

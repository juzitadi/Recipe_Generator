 ...
 * @generated
 */
public class SpeakActionTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SpeakActionTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeParserProvider.getParser(RecipeElementTypes.SpeakAction_2001, getParserElement(),
					RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.SpeakActionTextEditPart.VISUAL_ID));
		}
		return parser;
	}

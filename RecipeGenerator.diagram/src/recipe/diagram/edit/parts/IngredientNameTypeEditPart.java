 ...
 * @generated
 */
public class IngredientNameTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IngredientNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeParserProvider.getParser(RecipeElementTypes.Ingredient_3001, getParserElement(),
					RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.IngredientNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class RecipeActionTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RecipeActionTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeParserProvider.getParser(RecipeElementTypes.RecipeAction_2006, getParserElement(),
					RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.RecipeActionTextEditPart.VISUAL_ID));
		}
		return parser;
	}

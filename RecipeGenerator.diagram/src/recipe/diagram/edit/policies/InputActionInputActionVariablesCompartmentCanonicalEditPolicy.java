 ...
 * @generated
 */
public class InputActionInputActionVariablesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return RecipePackage.eINSTANCE.getInputAction_Variables();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<RecipeNodeDescriptor> childDescriptors = RecipeDiagramUpdater
				.getInputActionInputActionVariablesCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == IngredientEditPart.VISUAL_ID || visualID == DeviceEditPart.VISUAL_ID
				|| visualID == TasteEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<RecipeNodeDescriptor> childDescriptors = RecipeDiagramUpdater
				.getInputActionInputActionVariablesCompartment_7001SemanticChildren((View) getHost().getModel());

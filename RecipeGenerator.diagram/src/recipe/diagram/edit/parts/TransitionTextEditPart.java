...
public class TransitionTextEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.TransitionTextEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeParserProvider.getParser(RecipeElementTypes.Transition_4001, getParserElement(),
					RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.TransitionTextEditPart.VISUAL_ID));
		}
		return parser;
	}

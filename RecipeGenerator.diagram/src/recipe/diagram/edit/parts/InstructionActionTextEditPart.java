 ...
 * @generated
 */
public class InstructionActionTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InstructionActionTextEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new RecipeTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeParserProvider.getParser(RecipeElementTypes.InstructionAction_2002, getParserElement(),
					RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.InstructionActionTextEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, RecipeEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}

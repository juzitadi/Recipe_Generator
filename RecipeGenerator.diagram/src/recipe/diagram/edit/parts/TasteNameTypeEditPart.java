 ...
 * @generated
 */
public class TasteNameTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TasteNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeParserProvider.getParser(RecipeElementTypes.Taste_3003, getParserElement(),
					RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.TasteNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}

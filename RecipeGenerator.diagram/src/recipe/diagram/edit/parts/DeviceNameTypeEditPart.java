 ...
 * @generated
 */
public class DeviceNameTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DeviceNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeParserProvider.getParser(RecipeElementTypes.Device_3002, getParserElement(),
					RecipeVisualIDRegistry.getType(recipe.diagram.edit.parts.DeviceNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}

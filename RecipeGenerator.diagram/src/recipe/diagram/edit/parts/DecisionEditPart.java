...
import recipe.diagram.edit.policies.DecisionItemSemanticEditPolicy;
...
public class DecisionEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DecisionItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DecisionTextEditPart) {
			((DecisionTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureDecisionLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(RecipeVisualIDRegistry.getType(DecisionTextEditPart.VISUAL_ID));
	}
	...
	*/
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 128, 255, 255);
